...
///////////////////////////////////////////////////////////////////    
 ...
 ////////////////////////////////////////////////////////////////////////////
  ...
  //serial.onRawData(gotRawData);
   ...
   song1 = loadSound('assets/assets_sounds_bubbles.mp3');
       song2 = loadSound('assets/assets_sounds_confetti.mp3');
       song3 = loadSound('assets/assets_sounds_pinwheel.mp3');
...
function draw() {
  ...
  ellipseMode(RADIUS);    
  fill(255,0,0,255*(1-diameter0));
  noStroke(); 
  //console.log("diameter0  "  + diameter0);
  ellipse(300, 500, 50, 50);
  ellipseMode(RADIUS);  
  fill(255,0,0,255*diameter0);
  rect(250,450,100,100);
    
  fill(0,255,0);
  ellipse(700, 500, s2R1, s2R2);
  ellipseMode(RADIUS);
  fill(0,0,255);
  ellipse(1100, 500, s3R2, s3R1);
    
    if(diameter1/1000>0 && diameter1/1000<50)
    {
        s2R1 = diameter1/10;
        s2R2 = 50;
    }
    else if(diameter1/1000>50 && diameter1/1000<100)
    {
        s2R1 = 50;
        s2R2 = diameter1/10;
    }
    
        if(diameter2/33*100>0 && diameter2/33*100<50)
    {
        s3R1 = diameter2/33*100;
        s3R2 = 50;
    }
    else if(diameter2/33>50 && diameter2/33<100)
    {
        s3R1 = 50;
        s3R2 = diameter2/33*100;
    }
