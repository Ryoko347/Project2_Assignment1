...
function draw() {
  ...
  ellipseMode(RADIUS);    
  fill(255*diameter0,0,0);
  noStroke(); 
  //console.log("diameter0  "  + diameter0);
    rect(250,1000 - diameter3/2,100,100)
 // ellipse(300, 1000 - diameter3/2 , 50, 50);
  //ellipseMode(RADIUS);  

  fill(0,255*(diameter1),0);
    rect(650,diameter3/2,100,100)
  //ellipse(700, diameter3/2, 50, 50);
  //ellipseMode(RADIUS);

  fill(0,0,255*(diameter2 - 1));
        rect(1050,1000 - diameter3/2,100,100)
  //ellipse(1100, 1000 - diameter3/2, 50, 50);
